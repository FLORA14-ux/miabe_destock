...
import 'services/api_service.dart'; // ← Assure-toi que ce chemin correspond à ton projet
...
class _AuthPageState extends State<AuthPage> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildMainButton("Se connecter", _isLoading ? null : _handleLogin),
        ],
      ),
    );
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildMainButton("S'inscrire", _isLoading ? null : _handleRegister),
          ],
        ),
      ),
    );
  ...
  void _handleLogin() async {
    ...
    if (_loginPasswordController.text.isEmpty ||
      ...
      _showErrorSnackBar("Mot de passe invalide");
      return;
    }
    ...
    try {
      ...
      if (res.containsKey('token')) {
        ...
        _showErrorSnackBar("Erreur inconnue lors de la connexion");
      }
    } catch (e) {
      setState(() => _isLoading = false);
  ...
  void _handleRegister() async {
    ...
    try {
      ...
      if (res.containsKey('token')) {
        ...
        _showErrorSnackBar("Erreur inconnue lors de l'inscription");
      }
    } catch (e) {
      setState(() => _isLoading = false);
      _showErrorSnackBar("Impossible de se connecter au serveur");
